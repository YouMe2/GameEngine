...
public enum Obstacle {
	...
	SINGLE(LHPIXEL_WIDTH * 4, x -> {
		...
		e.move(0, -e.getFullSimpleViewable().getHeight());
		...
		e0.move(0, -e0.getFullSimpleViewable().getHeight());
		e0.setGravityActive(true);
		KittenEnemy e1 = new KittenEnemy(ENEMYRESKEY, new Point(LHPIXEL_WIDTH * 2 + x + e0.getFullSimpleViewable().getWidth() + distance, FLOOR_POS));
		e1.move(0, -e1.getFullSimpleViewable().getHeight());
		...
		KittenEnemy e = new KittenEnemy(ENEMYRESKEY, new Point(LHPIXEL_WIDTH * 2 + x, FLOOR_POS));
		e.move(0, -e.getFullSimpleViewable().getHeight() - hoveringHeight);
		...
		int hoveringHeight = (int) (LHPIXEL_HEIGHT * 1.1);
		KittenEnemy e0 = new KittenEnemy(ENEMYRESKEY, new Point(LHPIXEL_WIDTH * 2 + x, FLOOR_POS));
		e0.move(0, -e0.getFullSimpleViewable().getHeight() - hoveringHeight);
		e0.setGravityActive(false);
		KittenEnemy e1 = new KittenEnemy(ENEMYRESKEY, new Point(LHPIXEL_WIDTH * 2 + x + e0.getFullSimpleViewable().getWidth() + distance, FLOOR_POS));
		e1.move(0, -e1.getFullSimpleViewable().getHeight() - hoveringHeight);
		...
		e0.move(0, -e0.getFullSimpleViewable().getHeight() - hoveringHeight);
		e0.setGravityActive(false);
		KittenEnemy e1 = new KittenEnemy(ENEMYRESKEY, new Point(x + e0.getFullSimpleViewable().getWidth() + distance, FLOOR_POS));
		e1.move(0, -e1.getFullSimpleViewable().getHeight() - hoveringHeight);
		e1.setGravityActive(false);
		KittenEnemy e2 = new KittenEnemy(ENEMYRESKEY, new Point(e1.getFullSimpleViewable().getX() + e1.getFullSimpleViewable().getWidth() + distance, FLOOR_POS));
		e2.move(0, -e1.getFullSimpleViewable().getHeight() - hoveringHeight);
		...
		e0.move(0, -e0.getFullSimpleViewable().getHeight() - hoveringHeightLower);
		e0.setGravityActive(false);
		KittenEnemy e1 = new KittenEnemy(ENEMYRESKEY, new Point(x + spaceBefore, FLOOR_POS));
		e1.move(0, -e1.getFullSimpleViewable().getHeight() - hoveringHeightUpper);
		e1.setGravityActive(false);
		return new GameElement[] { e0, e1 };
